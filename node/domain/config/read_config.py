...
from node.domain.config.field import TemplateKeyName, FieldsTemplate
...
nuke_shot = FieldsTemplate(
    ...
    fields={
        ...
        "Shot": shot_root,
        "Task": step_root,
        "variant": nuke_shot_render_folder,
        "version": nuke_shot_render_folder,
        "colorspace": nuke_shot_render_folder,
        "write": nuke_shot_render_folder,
        "extension": nuke_shot_render_sequence,
    }
)
